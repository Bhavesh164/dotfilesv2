...
# info: this is a script to launch other rofiscripts,
...
# open bookmarks
COMMANDS["bookmarks"]="~/scripts/rofi/rofi-surfraw-bookmarks.sh"
LABELS["bookmarks"]=""

# search local files
COMMANDS["locate"]="~/scripts/rofi/rofi-locate.sh"
LABELS["locate"]=""
...
# COMMANDS["#screenshot"]='/home/dka/bin/screenshotscripts/myscreenshot.sh'
...
function start()
{
    ...
    print_menu | sort | rofi -dmenu -mesg ">>> launch your collection of rofiscripts" -i -p "rofi-bangs: "
